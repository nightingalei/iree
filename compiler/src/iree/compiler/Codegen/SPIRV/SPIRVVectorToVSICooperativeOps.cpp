...
struct SPIRVVectorToVSICooperativeOpsPass final
    : public SPIRVVectorToVSICooperativeOpsBase<SPIRVVectorToVSICooperativeOpsPass> {
...
createSPIRVVectorToVSICooperativeOpsPass() {
  return std::make_unique<SPIRVVectorToVSICooperativeOpsPass>();
}
