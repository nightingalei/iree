...
#define DEBUG_TYPE "iree-spirv-tile-and-vectorize-to-vsicooperative-ops"
...
class SPIRVTileAndVectorizeToVSICooperativeOpsPass final
    : public SPIRVTileAndVectorizeToVSICooperativeOpsBase<
          SPIRVTileAndVectorizeToVSICooperativeOpsPass> {
 public:
...
createSPIRVTileAndVectorizeToVSICooperativeOpsPass() {
  return std::make_unique<SPIRVTileAndVectorizeToVSICooperativeOpsPass>();
}
